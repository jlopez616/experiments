...
jsPsych.plugins['survey-text'] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        for (var i = 0; i < trial.questions.length; i++) {
            ...
            // add text box
            $("#jspsych-survey-text-" + i).append('<input class="center-block-text" maxlength="3" id="userID" name="#jspsych-survey-text-response-' + i + '" cols="' + 2 + '" rows="' + 1 + '"></input>');
        }
